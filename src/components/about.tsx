...
const About: React.FC = () => {
    ...
    return (
        <div
          ref={ref}
          className={`flex flex-col lg:h-screen w-full transition-opacity duration-700 ${isVisible ? "opacity-100 animate-fadeIn" : "opacity-0"}`}>
          ...
          <div className="flex flex-row items-center justify-center lg:mx-20">
            <img src={photo} alt="Christopher West" width={400} className="hidden xl:block mr-20" />
            <div className="flex flex-col space-y-7">
              <p className="text-xl lg:text-2xl max-w-5xl">
